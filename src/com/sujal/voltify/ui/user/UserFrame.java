...
public class UserFrame extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(e.getSource() == mEstimateCostButton) {
			EstimateCostFrame.start();
		}
		else if(e.getSource() == mCheckPastBillsButton) {
			CheckPastBillsFrame.start();
		}else if(e.getSource() == mUploadNewBillButton) {
			UploadBillFrame.start();
		}
	}
